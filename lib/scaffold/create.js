...
var BASE_PACKAGE = {
  description: 'A full Horizen node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-zen': 'psyraxaus/bitcore-lib-zen',
    'bitcore-node-zen': 'psyraxaus/bitcore-node-zen/psyraxaus/myrepos'
  }
};
